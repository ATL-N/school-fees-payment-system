      ...
      <div className='input-area-container div2'>
        ...
        <form action="" onSubmit={props.handleSubmit1} className='input-area-div div2 div3' >
          ...
          <div className='group-div'>
            ...
            <div className='form-input-div'>select subject: 
              <select required defaultValue={''} name="subjectId" id="subjectId" className='form-input' 
              onChange={(e) => props.handleSubjectChange(e, props.subjectResults)} 
              value={props.myFormData.subjectId}
              >
                <option value="" disabled >select subject from system</option>
            ...
            <div className='form-input-div'>select Teacher: 
              <select required defaultValue={''} name="staffId" id="staffId" className='form-input' 
              onChange={(e) => props.handleInputChange(e, props.staffResults)} 
              value={props.myFormData.staffId}
              >
                <option value="" disabled >select Teacher from system</option>
          ...
          <div className="nav-buttons">
            ...
            <div className="clear-btn-div"> 
              ...
              {props.id? props.myFormData.subjectName && <input type="submit" value="Update"  title="upload the product"  className="form-button nav-button next-btn submit-btn"/> : props.myFormData.subjectName && <input type="submit" value="SELECT"  title="upload the product"  className="form-button nav-button next-btn submit-btn"/>}
          </div>
